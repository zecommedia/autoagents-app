...
export const CloneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M16 16.4V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v12.4" />
        <path d="M12 20h.01" />
        <path d="M16 20h.01" />
        <path d="M8 20h.01" />
        <path d="M4 20h.01" />
...
export const EraserIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12.42 22H6a2 2 0 0 1-2-2V8.42a2 2 0 0 1 .59-1.42l5.41-5.41a2 2 0 0 1 2.83 0l5.41 5.41a2 2 0 0 1 .59 1.42V13" />
    <path d="m18 13-5-5" />
    <path d="m22 17-5-5" />
    <path d="M12.42 22 22 12.42" />
  </svg>
);

export const AIEraserIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    {/* Eraser part */}
    <path d="M12.42 22H6a2 2 0 0 1-2-2V8.42a2 2 0 0 1 .59-1.42l5.41-5.41a2 2 0 0 1 2.83 0l5.41 5.41a2 2 0 0 1 .59 1.42V13" />
    <path d="M12.42 22 22 12.42" />
    {/* Wand part (simplified) */}
    <path d="m22 2-2.5 2.5" />
    <path d="m19.5 7-2.5-2.5" />
    <path d="M17 4.5 14.5 2" />
  </svg>
);
...
export const StraightenTextIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 7V5h16v2"/>
...
export const StrokeWidthIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RefreshIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 18" />
        <path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 6" />
        <path d="M3 6v6h6" />
        <path d="M21 18v-6h-6" />
    </svg>
);
